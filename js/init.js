				...
				$window.resize(function() {
					...
					resizeTimeout = window.setTimeout(function() {
						...
						// Update scrolly links.
							$('a[href^=#intro]').scrolly(1500, $header.outerHeight() - 1);
                            $('a[href^=#one]').scrolly(1500, $header.outerHeight() - 1);
                            $('a[href^=#two]').scrolly(1500, $header.outerHeight() - 1);
                            $('a[href^=#work]').scrolly(1500, $header.outerHeight() - 1);
                            $('a[href^=#work2]').scrolly(1500, $header.outerHeight() - 1);
                            $('a[href^=#contact]').scrolly(1500, $header.outerHeight() - 1);
